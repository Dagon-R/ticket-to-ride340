...
import static Phase2Models.City.Atlanta;
import static Phase2Models.City.Boston;
import static Phase2Models.City.Calgary;
import static Phase2Models.City.Charleston;
import static Phase2Models.City.Chicago;
import static Phase2Models.City.Dallas;
import static Phase2Models.City.Denver;
import static Phase2Models.City.Duluth;
import static Phase2Models.City.El_Paso;
import static Phase2Models.City.Helena;
import static Phase2Models.City.Houston;
import static Phase2Models.City.Kansas_City;
import static Phase2Models.City.Las_Vegas;
import static Phase2Models.City.Little_Rock;
import static Phase2Models.City.Los_Angeles;
import static Phase2Models.City.Miami;
import static Phase2Models.City.Montreal;
import static Phase2Models.City.Nashville;
import static Phase2Models.City.New_Orleans;
import static Phase2Models.City.New_York;
import static Phase2Models.City.Oklahoma_City;
import static Phase2Models.City.Omaha;
import static Phase2Models.City.Phoenix;
import static Phase2Models.City.Pittsburgh;
import static Phase2Models.City.Portland;
import static Phase2Models.City.Raleigh;
import static Phase2Models.City.Saint_Louis;
import static Phase2Models.City.Salt_Lake_City;
import static Phase2Models.City.San_Francisco;
import static Phase2Models.City.Santa_Fe;
import static Phase2Models.City.Sault_St_Marie;
import static Phase2Models.City.Seattle;
import static Phase2Models.City.Toronto;
import static Phase2Models.City.Vancouver;
import static Phase2Models.City.Washington;
import static Phase2Models.City.Winnipeg;
import static Phase2Models.TrainCardColor.*;
import static Phase2Models.TrainCardColor.BLACK;
import static Phase2Models.TrainCardColor.BLUE;
import static Phase2Models.TrainCardColor.GREEN;
import static Phase2Models.TrainCardColor.ORANGE;
import static Phase2Models.TrainCardColor.PURPLE;
import static Phase2Models.TrainCardColor.RAINBOW;
import static Phase2Models.TrainCardColor.RED;
import static Phase2Models.TrainCardColor.WHITE;
import static Phase2Models.TrainCardColor.YELLOW;
